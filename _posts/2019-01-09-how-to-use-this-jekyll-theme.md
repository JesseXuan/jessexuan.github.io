---
layout: post
title:  如何使用LessOrMore这个Jekyll模版(基于Jekyll.org下载模板后更新)
date:   2019-01-09 01:08:00 +0800
...
前言
====================================
+ 本文是基于Jekyll.org下载的LessOrMore框架拷贝过来的。下载后的原始内容为Freud kang重构内容，然后根据本人信息修改。
...
热爱开源，热爱折腾的Java程序猿。更多个人信息和联系方式可以参照[我的简介](http://jessexuan.github.io/)。
